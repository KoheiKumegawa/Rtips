#----------------------------------------------------------------------------
# scA01c_makeArchRProj_customGenome.R
#----------------------------------------------------------------------------
...
#addArchRGenome("mm10")
customGenomeAnnotation <- readRDS("rds/customGenomeAnnotation.rds")
customGeneAnnotation   <- readRDS("rds/customGeneAnnotation.rds")
...
ArrowFiles <- createArrowFiles(inputFiles = paste0("data//", outFile), 
                               ...
                               genomeAnnotation = customGenomeAnnotation, 
                               geneAnnotation = customGeneAnnotation,
                               force = TRUE)
